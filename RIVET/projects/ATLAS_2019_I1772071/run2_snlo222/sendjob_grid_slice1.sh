...
lsetup panda
pathena --extOutFile=run2_snlo222_pty_17_35.yoda.gz \
        --inDS=mc15_13TeV.364541.Sherpa_222_NNPDF30NNLO_SinglePhoton_pty_17_35.evgen.EVNT.e6788 \
        --outDS=user.dcamarer.364541.Sherpa_222_NNPDF30NNLO_SinglePhoton_pty_17_35.analph2jets.v1 \
        RivetAnalysis_13TeV_ph2jets_slice1.py
