...
print (f"  → CrossSection = {1000000 * xssum/float(nfiles) * effsum/float(nfiles)} fb")
rivet.CrossSection = 1000000 * xssum/nfiles * effsum/nfiles # The factor 1000 is needed to move from nb to fb (used in the paper)
