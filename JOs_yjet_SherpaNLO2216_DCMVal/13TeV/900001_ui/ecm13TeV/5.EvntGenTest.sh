...
echo "ncores=1 nhours=24 ${BASE_DIR_ext}/5.EvntGenTest.sh"
...
Gen_tf.py --ecmEnergy=${DEFAULT_ENERGY_CM} --maxEvents=1 --firstEvent=1 --randomSeed=10 --jobConfig=${BASE_DIR} --postInclude=events.py --outputEVNTFile=${outputEVNTFile} --maxEvents=100
cat log.generate
