...
echo 'ncores=12 nhours=24 /afs/cern.ch/work/d/dcamarer/private/PostDoc/PMG/MCJobOptionsDevelopment/JOs_yjet_SherpaNLO2216_DCMVal/13TeV/900001_ui/900001/ecm13TeV/3.integrate.sh';
