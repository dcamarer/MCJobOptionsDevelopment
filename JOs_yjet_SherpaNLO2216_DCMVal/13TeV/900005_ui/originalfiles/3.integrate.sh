...
echo 'ncores=12 nhours=24 /afs/cern.ch/work/d/dcamarer/private/PostDoc/PMG/MCJobOptionsDevelopment/JOs_yjet_SherpaNLO2216_DCMVal/13TeV/900005_ui/900005/ecm13TeV/3.integrate.sh';
