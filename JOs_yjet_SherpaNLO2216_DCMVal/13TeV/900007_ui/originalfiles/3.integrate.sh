...
echo 'ncores=12 nhours=24 /afs/cern.ch/work/d/dcamarer/private/PostDoc/PMG/MCJobOptionsDevelopment/JOs_yjet_SherpaNLO2216_DCMVal/13TeV/900007_ui/900007/ecm13TeV/3.integrate.sh';
...
sed '/.*\}(run).*/i\ \ BEAM_ENERGY_1=6500.0' -i Run.dat
sed '/.*\}(run).*/i\ \ BEAM_ENERGY_2=6500.0' -i Run.dat
...
mpirun -n 12 /cvmfs/sft.cern.ch/lcg/releases/LCG_107a_ATLAS_9/MCGenerators/sherpa/${SHERPAVER}.openmpi3/${LCG_PLATFORM}/bin/Sherpa EVENTS=0 FRAGMENTATION=Off MI_HANDLER=None BEAM_ENERGY_1=6500.0 BEAM_ENERGY_2=6500.0
exit 0
