...
BASE_DIR="/home/dcamarero/PostDoc/PMG/MCJobOptionsDevelopment/JOs_yjet_SherpaNLO2216_DCMVal_final/13p6TeV/900006_ui"
BASE_DIR_ext="${BASE_DIR}/ecm13p6TeV"
DEFAULT_NCORES=1
DEFAULT_ENERGY_BEAM=6800.0
...
Gen_tf.py --ecmEnergy=${ENERGY_CM} --maxEvents=5 --firstEvent=1 --randomSeed=10 --jobConfig=${BASE_DIR} --postInclude=events.py --outputEVNTFile=${outputEVNTFile}
cat log.generate
