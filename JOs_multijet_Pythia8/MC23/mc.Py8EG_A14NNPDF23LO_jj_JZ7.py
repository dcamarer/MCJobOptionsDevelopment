# JO for Pythia 8 jet jet JZ7 slice

evgenConfig.description = "Dijet truth jet slice JZ7, with the A14 NNPDF23 LO tune"
...
#include("GeneratorFilters/JetFilter_JZ7.py")
