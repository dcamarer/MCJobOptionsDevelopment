...
pathena --trf "Gen_tf.py --ecmEnergy=13000 --randomSeed %RNDM:9998 --outputEVNTFile %OUT.EVNT.root --jobConfig=100002 --maxEvents=1000" --outDS user.dcamarer.run2_100002_260321 --split 10 --maxCpuCount 259200
